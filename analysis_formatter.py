...
class AnalysisFormatter:
    _option_to_heading_map = {
        ...
        "ГЛАЗА_ГЛУБИНА": {
            "Глубоко": "ГЛУБОКО ПОСАЖЕННЫЕ ГЛАЗА",
        ...
        for category_key, selected_option in selected_params.items():
            ...
            if heading:
                ...
                if file_name_for_category and file_name_for_category in raw_data_maps:
                    ...
                    # Если описание не найдено - просто пропускаем, ничего не добавляем
                # Если данные для категории не найдены - просто пропускаем, ничего не добавляем
            # Если заголовок не найден - просто пропускаем, ничего не добавляем
